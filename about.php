...
<main>
    <div class="container">
        <div id="ant-layout">
            ...
            <section class="main">
                <div class="row">
                    <h3>Watch Store là gì?</h3>
                    <p>Một sản phẩm phát triển bởi PomanJR</p>
                    <p>CRUD Website</p>
                    <p style="text-align: center;">© 2022 Watch Store Website</p>
                </div>
                <!-- <div class="row">
                    <h3>Kim Anh Food hoạt động như thế nào?</h3>
                    <p>Kim Anh Food hoạt động từ 7h đến 22h hằng ngày, tuỳ theo khu vực của bạn và thời gian mở cửa cụ thể của từng nhà hàng, quán ăn.</p>
                </div>
                <div class="row">
